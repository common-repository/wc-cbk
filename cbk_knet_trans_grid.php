    ...
    class Alnazer_Cbk_KNET_Trans_Grid extends WP_List_Table
    {
        ...
        public function search_box( $text, $input_id ) {
            ...
            <form action="admin.php" method="get">
                ...
                <div>
                    ...
                    <a class="button reset" href="admin.php?page=<?php echo esc_attr($_REQUEST['page'] ?? ""); ?>&cbk_knet_export=csv&<?php echo http_build_query($http_build_query) ?>"><?php  echo __('Export csv', "cbk_knet") ?></a>
                </div>
        ...
        public function get_columns()
        {
            return $columns= array(
                ...
                'pay_method'=>__('Pay Method', "cbk_knet"),
                'ReceiptNo'=>__('ReceiptNo', "cbk_knet"),
				'AuthCode'=>__('AuthCode', "cbk_knet"),
				'PostDate'=>__('PostDate', "cbk_knet"),
        ...
        public function column_default( $item, $column_name ) {
            ...
            switch ( $column_name ) {
                ...
                case 'result':
                    return ($item[$column_name] !== "Success") ? sprintf("<span  style='color:red'>%s</span>",__($item[ $column_name ],"cbk_knet")) : sprintf("<span  style='color:green'>%s</span>",__($item[ $column_name ],"cbk_knet"));
                case 'pay_method':
                    return Alnazer_CBK_Payment_Method_Values[get_post_meta($item["order_id"],Alnazer_CBK_Payment_Method_Key ,true)] ?? "";
				case 'ReceiptNo':
